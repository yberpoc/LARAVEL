            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggl="tab" href="#mindata" role="tab">Основные данные</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggl="tab" href="#adddata" role="tab">Доп данные</a>
                        </li>
                    </ul>
                    <br>
                    <div class="tab-content">
                        <div class="tab-pane active" id="maindata" role="tabpanel">
                            ...
                            <div class="tab-pane" id="adddate" role="tabpanel">
                                <div class="form-group">
